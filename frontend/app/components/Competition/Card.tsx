...
interface cardProps {
    ...
    imgLogo?: string | StaticImageData;
}

export default function Card({src, imgLogo}: cardProps) {
  return (
    <div className="flex-1 max-w-xs rounded-xl overflow-hidden shadow-sm hover:shadow-md transition m-1 bg-white hover:border hover:border-gray-500">
      ...
      <div className="p-4 mt-3">
        <h2 className="font-bold text-lg text-gray-800 overflow-hidden mb-2"
        style={{
            display: "-webkit-box",
            WebkitLineClamp: 2,
        ...
        <div className="flex items-center justify-between mt-4 text-sm text-gray-600">
            <div>
                <div className="flex items-center mb-2">
                    ...
                    <span className="text-xs">7,579 Views</span>
                </div>
